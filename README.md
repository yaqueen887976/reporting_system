...
## 5. My Improvement
1. Add Lambda Expresion, send email
2. Improve sync API performance by using multithreading and sending request concurrently to both services. in /client/service/ReportServiceImpl
3. Use a database instead of hashmap in the ExcelRepositoryImpl.
4. Add new features of delete report in clientService
