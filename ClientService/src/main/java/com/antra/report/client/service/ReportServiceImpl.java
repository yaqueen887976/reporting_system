...
public class ReportServiceImpl implements ReportService {
    ...
    private void sendDirectRequests(ReportRequest request) {
        ...
        //create executor service to run those parallel
    ...
    //add delete
//    public void deleteAsyncRecord(ReportRequest request){
...
//    }
    ...
    //add delete
    public void deleteAsyncRecord(String reqId){
...
//    @Transactional // why this? email could fail
    public void updateAsyncPDFReport(SqsResponse response) {
        ...
        String to = "kimwang88797@gmail.com";
